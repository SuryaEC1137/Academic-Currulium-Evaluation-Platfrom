            ...
            <div className="overflow-x-auto">
                <table className="w-full text-left">
                    ...
                    <tbody className="divide-y divide-gray-100 dark:divide-white/5">
                        {filteredStudents.slice(0, displayLimit).map((student, i) => (
                            <motion.tr
                                key={student._id}
                ...
                {filteredStudents.length > displayLimit && (
                    <div className="p-6 flex justify-center border-t border-gray-100 dark:border-white/5">
                        <button
                            onClick={() => setDisplayLimit(prev => prev + 10)}
                            className="px-6 py-2 rounded-xl bg-indigo-600 text-white font-bold text-xs uppercase tracking-widest hover:bg-indigo-700 transition-all shadow-lg shadow-indigo-500/20"
                        >
                            Load More Cadets
                        </button>
                    </div>
