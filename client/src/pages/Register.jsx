...
const Register = () => {
    ...
    return (
        <div className="min-h-screen bg-slate-50 dark:bg-[#020617] text-slate-900 dark:text-white flex items-center justify-center p-4 py-24 relative overflow-hidden font-sans selection:bg-indigo-500/30 transition-colors duration-500">
            ...
            <div className="absolute inset-0 overflow-hidden pointer-events-none transform-gpu">
                <motion.div
                    className="absolute -top-[10%] -left-[10%] w-[60%] h-[60%] bg-indigo-500/10 dark:bg-indigo-600/5 rounded-full blur-[100px] animate-mesh"
                    style={{ animationDelay: '0s' }}
                />
                <motion.div
                    className="absolute -bottom-[10%] -right-[10%] w-[60%] h-[60%] bg-purple-500/10 dark:bg-purple-600/5 rounded-full blur-[100px] animate-mesh"
                    style={{ animationDelay: '-10s' }}
                />
            </div>

            <div className="absolute inset-0 opacity-[0.02] dark:opacity-[0.05] bg-[url('https://grainy-gradients.vercel.app/noise.svg')] pointer-events-none mix-blend-overlay"></div>
                    ...
                    <div className="relative z-10">
                        <div className="text-center mb-12">
                            <motion.div
                                ...
                                className="inline-flex items-center justify-center w-24 h-24 rounded-[2.5rem] bg-gradient-to-br from-indigo-500 via-indigo-600 to-purple-600 mb-8 shadow-3xl shadow-indigo-500/20 holographic-shine"
                            >
                            ...
                            <div className="flex items-center justify-center gap-4">
                                ...
                                <p className="text-slate-500 dark:text-slate-400 text-[11px] font-black uppercase tracking-[0.5em] kinetic-text">Join the academic evaluation platform</p>
                                <div className="h-px w-8 bg-indigo-500/20 dark:bg-indigo-500/40" />
                            </div>
                        </div>
                        ...
                        >
                            ...
                            <motion.div variants={itemVariants} className="md:col-span-6 space-y-2.5">
                                ...
                                <div className="relative group/input">
                                    ...
                                    <input
                                        type="text"
                                        name="name"
                                        className="w-full bg-white dark:bg-white/[0.03] border border-slate-200 dark:border-white/5 focus:border-indigo-500/40 rounded-2xl py-4.5 pl-12 pr-4 outline-none text-slate-900 dark:text-white font-bold placeholder:text-slate-300 dark:placeholder:text-gray-600 transition-all focus:bg-white focus:dark:bg-white/[0.05] shadow-inner"
                            ...
                            <motion.button
                                ...
                                whileTap={{ scale: 0.98 }}
                                type="submit"
                                className="md:col-span-12 font-black py-6 rounded-[2rem] bg-gradient-to-r from-indigo-600 via-indigo-500 to-purple-600 text-white shadow-3xl shadow-indigo-500/30 transition-all flex items-center justify-center gap-4 mt-8 text-xs uppercase tracking-[0.4em] border border-white/10 h-20"
                            >
                                Create My Account <ArrowRightIcon className="w-5 h-5 group-hover:translate-x-1 transition-transform" />
                            </motion.button>
                        </motion.form>
