                        ...
                        >
                            ...
                            <div className="grid grid-cols-1 gap-4">
                                {filteredCourses.length > 0 ? (
                                    <>
                                        {filteredCourses.slice(0, displayLimit).map(course => (
                                            <motion.div
                                                key={course._id}
                                                layout
                                                className="bg-white dark:bg-gray-800/40 backdrop-blur-md p-6 rounded-2xl shadow-sm border border-gray-100 dark:border-gray-700/50 hover:border-blue-500/50 hover:shadow-lg transition-all duration-300 group"
                                            >
                                                <div className="flex flex-col md:flex-row justify-between md:items-center gap-4">
                                                    <div className="flex items-center gap-5">
                                                        ...
                                                        <div>
                                                            <h3 className="text-xl font-bold text-gray-900 dark:text-white group-hover:text-blue-500 transition-colors uppercase tracking-tight">{course.name}</h3>
                                        ...
                                        {filteredCourses.length > displayLimit && (
                                            <div className="mt-8 flex justify-center">
                                                <button
                                                    ...
                                                    className="px-8 py-3 rounded-xl bg-blue-600 text-white font-bold text-xs uppercase tracking-widest shadow-lg shadow-blue-500/20 hover:shadow-blue-500/40 hover:-translate-y-1 transition-all"
                                                >
                                                    Load More Assets
                                                </button>
                                            </div>
